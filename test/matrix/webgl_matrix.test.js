...
function slowMult(m1, m2) {
    ...
    for (var ii = 0 | 0; ii < r1; ++ii) {
        // for each row in product
        for (var jj = 0 | 0; jj < c2; ++jj) {
            // for each column in product
            var sum = +0;
            for (var kk = 0 | 0; kk < c1; ++kk) {
                // for each item in sum - across m1, down m2
