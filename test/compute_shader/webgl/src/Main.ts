    ...
    let _compute = (
        ...
        for (let i = 0; i < instanceCount; ++i) {
            ...
            vVel = _add(
                ...
                _add(
                    _add(
                        _multiScalar(cMass, simParamData.rule1Scale),
                        _multiScalar(colVel, simParamData.rule2Scale)
                    ),
                    _multiScalar(cVel, simParamData.rule3Scale)
                )
            );
